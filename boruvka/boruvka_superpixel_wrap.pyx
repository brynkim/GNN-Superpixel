...
cdef class BoruvkaSuperpixel:
    ...
    def get_num_edge(self):
        return self._bosupix.get_num_edge()

    @property
    def get_num_node(self):
        return self._bosupix.get_num_node()

    @property
    def get_sources(self):
        cdef int * sources = self._bosupix.get_sources()
        return [sources[i] for i in range(self._bosupix.get_num_edge())]
    
    @property
    def get_destinations(self):
        cdef int * destinations = self._bosupix.get_destinations()
        return [destinations[i] for i in range(self._bosupix.get_num_edge())]
