...
# %%
for foldername in tqdm(os.listdir(f'./ImageNet/val')):
    for filename in os.listdir(f'./ImageNet/val/{foldername}'):
        filenames.append(f'./ImageNet/val/{foldername}/{filename}')
...
for chunk_id in trange(ceil(len(filenames) / UNIT)):
    ...
    df.to_pickle(f'/home/work/jupyter/dongjae/2023-fall/Lecture/Graph/GNN-Superpixel/converted_{NUM_SUPERPIXEL}/val/data{chunk_id:02d}.pkl')
